...
<body>
	<div class="container-fluid">
		...
		<div class="row content">
			<div id="title">Sửa thông tin môn học</div>
			...
			<div id="form-add">
				...
				<form action="subject" method="POST">
					...
					<input type="hidden" name="Sid" value="${oldSj.id }">
					<div class="form-group">
						<label for="">Tên môn học</label> <input type="text"
							class="form-control" id="" value="${oldSj.name }" name="name">
					</div>
					<div class="form-group">
						<label for="pwd">Nội dung</label>
						<textarea name="ckeditor" id="ckeditor" rows="10" cols="50">${oldSj.sumary }</textarea>
					</div>
